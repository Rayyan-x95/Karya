...
export const QRPreviewContainer: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center gap-3 bg-surface rounded-lg p-6">
      <div className="h-40 w-40 rounded-md overflow-hidden bg-white flex items-center justify-center ring-1 ring-inset ring-border-subtle">
        <img src={qrUrl} alt="QR Code for payment" className="h-full w-full object-contain" />
      </div>
