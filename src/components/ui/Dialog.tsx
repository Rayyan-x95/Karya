        ...
        {(title || description) && (
          <div className="flex items-start justify-between gap-4 px-5 pt-5 pb-4">
            <div className="space-y-1 min-w-0">
              {title && <h2 id="dialog-title" className="text-heading text-foreground m-0">{title}</h2>}
              {description && <p id="dialog-description" className="text-small text-muted-foreground m-0">{description}</p>}
            </div>
            <button
              onClick={onClose}
    ...
    <div className="fixed inset-0 z-50 flex overflow-hidden">
      ...
      >
        <div className="flex items-center justify-between px-5 py-4">
          {title && <h2 className="text-heading text-foreground m-0">{title}</h2>}
          <button
            onClick={onClose}
